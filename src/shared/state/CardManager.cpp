...
CardManager::CardManager (){
  ...
  cards.push_back(std::move(std::make_unique<Card>("Blow", 1, 2, "res/textures/icons/attack.png", 1, 6, 0, 0, 0, 0, std::make_unique<Debuff>(0,3), std::make_unique<Buff>(0,0,0,0,0))));
  //water
  ...
  cards.push_back(std::move(std::make_unique<Card>("Group heal", 2, 3, "res/textures/icons/heal_block.png", 2, 0, 7, 0, 0, 0, std::make_unique<Debuff>(3,0), std::make_unique<Buff>(0,0,4,0,0))));
  //earth
  ...
  cards.push_back(std::move(std::make_unique<Card>("Fire shield", 2, 0, "res/textures/icons/retaliate.png", 4, 0, 0, 0, 0, 0, std::make_unique<Debuff>(0,0), std::make_unique<Buff>(0,0,0,0,2))));
  ...
  cards.push_back(std::move(std::make_unique<Card>("Inferno", 2, 2, "res/textures/icons/attack.png", 4, 8, 0, 0, 0, 0, std::make_unique<Debuff>(0,0), std::make_unique<Buff>(0,0,0,0,0))));
